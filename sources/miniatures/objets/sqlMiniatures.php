...
class sqlMiniatures 
{
    ...
    public function __construct () {
        ...
        $this->healtPointSkirmich = [['id'=>1, 'healtPoint'=>'6 points<br/> Endurance 4+'],
                                    ['id'=>2, 'healtPoint'=> '6 points<br/> Endurance 5+'],
                                    ['id'=>3, 'healtPoint'=> '8 points<br/> Endurance 5+'],
                                    ['id'=>4, 'healtPoint'=> '8 points<br/> Endurance 6+'],
                                    ['id'=>5, 'healtPoint'=> '10 points<br/> Endurance 6+'],
                                    ['id'=>6, 'healtPoint'=> '10 points<br/> Endurance 7+'],];
