...
if ($mark == $controle_POST) {
    ...
    if($addMiniatureArmyList->limitOfSkirmich($param)) {
    ...
    return header('location:../index.php?idNav='.$idNav.'&message=Add in army list !&idArmyList='.filter($_POST[$arrayKeys[2]]));
        ...
        return header('location:../index.php?idNav='.$idNav.'&message=Limit number of skirmich list&idArmyList='.filter($_POST[$arrayKeys[2]]));
    }
} else {
